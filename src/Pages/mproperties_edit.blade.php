...
<div class="page-content-wrap">
	...
	<div class="row">
		<div class="col-md-12">
			...
			@endif @if(isset($item)) {{
			Form::model($item,array('route'=>array('{clientId}.applicationproperties.update',$clientId, $item->id),
			'class'=>'form-horizontal')) }} <input type="hidden" name="_method"
				value="PUT"> @else {{
			Form::open(array('route'=>array('{clientId}.applicationproperties.store', $clientId), 'method' =>
